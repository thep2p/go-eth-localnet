...
See [CLAUDE.md Function Documentation Guidelines](CLAUDE.md#function-documentation-guidelines) for detailed documentation requirements, error classification patterns, and examples.
